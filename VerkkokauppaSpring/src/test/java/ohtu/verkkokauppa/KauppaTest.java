...
public class KauppaTest {
    ...
    public void TilisiirtoToimiiOikeinKahdellaEriTuotteella() {
        ...
        when(varasto.haeTuote(2)).thenReturn(new Tuote(1, "Dewi", 2));
    ...
    @Test
    public void TilisiirtoToimiiOikeinJosEiSaldoa() {
        Pankki pankki = mock(Pankki.class);
        Viitegeneraattori viite = mock(Viitegeneraattori.class);
        when(viite.uusi()).thenReturn(42);
        Varasto varasto = mock(Varasto.class);
    ...
    @Test
    public void TilisiirtoToimiiOikeinKunAloitaAsiointi() {
        Pankki pankki = mock(Pankki.class);
        Viitegeneraattori viite = mock(Viitegeneraattori.class);
        when(viite.uusi()).thenReturn(42);
        Varasto varasto = mock(Varasto.class);
    ...
    @Test
    public void ViitettaKutsutaanOikein() {
        Pankki pankki = mock(Pankki.class);
        Viitegeneraattori viite = mock(Viitegeneraattori.class);
        ...
        verify(pankki).tilisiirto(eq("pekka"), eq(43), eq("12345"), anyString(), eq(2));
